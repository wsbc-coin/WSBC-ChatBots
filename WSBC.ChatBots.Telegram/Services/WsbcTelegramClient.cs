...
namespace WSBC.ChatBots.Telegram.Services
{
    ...
    internal class WsbcTelegramClient : ITelegramClient, IDisposable
    {
        ...
        public WsbcTelegramClient(IOptionsMonitor<TelegramOptions> options, ILogger<WsbcTelegramClient> log)
        {
            this._log = log;
